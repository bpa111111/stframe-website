...
<body class="bg-slate-50 text-slate-800 antialiased flex flex-col min-h-screen">
  ...
  <!-- MOBILE MENU DRAWER -->
  <div id="mobile-menu" class="fixed inset-0 z-50 bg-slate-950 backdrop-blur-lg hidden flex flex-col justify-between p-6">
    <div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
        ...
        <div class="space-y-3">
          ...
          <ul class="space-y-2 text-xs">
            ...
            <li><a href="contact.html#cctv" class="hover:text-orange-400 transition" data-th="นโยบายกล้องวงจรปิด (CCTV)" data-en="CCTV Privacy Policy">นโยบายกล้องวงจรปิด (CCTV)</a></li>
