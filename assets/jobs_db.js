/**
 * ST. Frame & Truss Co., Ltd. - Official Job Openings Database (JobThai Verified)
 * Source: https://www.jobthai.com/th/company/272705
 */
const ST_JOBS_DB = [
  {
    id: 1181739,
    url: "https://www.jobthai.com/th/job/1181739",
    title_th: "วิศวกรประเมินราคา",
    title_en: "Cost Estimation Engineer",
    category_th: "งานวิศวกรรม (Engineering)",
    category_en: "Civil & Structural Engineering",
    salary_th: "ตามตกลง / ประสบการณ์",
    salary_en: "Negotiable based on experience",
    type_th: "งานประจำ (Full-time)",
    type_en: "Full-time",
    workplace_th: "ประจำโรงงานอยุธยา (อ.บางปะหัน จ.พระนครศรีอยุธยา)",
    workplace_en: "Ayutthaya Plant, Bang Pahan, Ayutthaya",
    working_hours_th: "วันจันทร์ - วันเสาร์ เวลา 07:45 - 17:00 น.",
    working_hours_en: "Monday - Saturday: 07:45 - 17:00",
    badge_color: "orange",
    responsibilities_th: [
      "คิดน้ำหนักและประเมินราคาโครงสร้างเหล็ก (Takeoff & Cost Estimation)",
      "ประสานงานกับลูกค้าและผู้เกี่ยวข้องในงานที่รับผิดชอบ",
      "วิเคราะห์และจัดทำเอกสารเสนอราคา (BOQ) และงานอื่นๆ ที่ได้รับมอบหมาย"
    ],
    responsibilities_en: [
      "Steel structural takeoff, weight calculation, and project cost estimation",
  ...
  {
    id: 1888744,
    url: "https://www.jobthai.com/th/job/1888744",
    title_th: "ผู้จัดการฝ่าย / หัวหน้าฝ่ายจัดซื้อ",
    title_en: "Procurement Manager / Head of Purchasing",
    category_th: "งานจัดซื้อ / ธุรการ (Procurement)",
    category_en: "Purchasing & Sourcing Management",
    ...
    badge_color: "amber",
    responsibilities_th: [
      "วางแผนและคัดเลือกวัตถุดิบ สินค้า และสรรหาคู่ค้า (Supplier Sourcing)",
      ...
      "ประสานงานกับฝ่ายต่างๆ และปฏิบัติงานอื่นๆ ตามที่ได้รับมอบหมาย"
    ],
    responsibilities_en: [
      "Lead strategic supplier sourcing, material procurement, and vendor negotiations",
    ...
    qualifications_th: [
      ...
      "มีประสบการณ์ด้านงานจัดซื้อ 5 - 10 ปี ในระดับหัวหน้างานหรือผู้จัดการ (หากมีประสบการณ์ในธุรกิจโครงสร้างเหล็กหรือก่อสร้างจะพิจารณาเป็นพิเศษ)",
      "มีความเป็นผู้นำ มีความละเอียดรอบคอบ สามารถวางแผนและบริหารทีมงานได้อย่างมีประสิทธิภาพ"
    ],
    qualifications_en: [
      "Any gender, aged 35 - 45 years",
  ...
  {
    id: 1356457,
    url: "https://www.jobthai.com/th/job/1356457",
    title_th: "เจ้าหน้าที่ตรวจสอบคุณภาพ QC (งานสี)",
    title_en: "QC Inspector (Painting & Coating)",
    category_th: "งานผลิต / ควบคุมคุณภาพ (QC Painting)",
    category_en: "Quality Assurance - Industrial Coating",
    salary_th: "ตามโครงสร้างบริษัทฯ",
    salary_en: "Company Salary Structure",
    type_th: "งานประจำ (Full-time)",
    type_en: "Full-time",
    ...
    badge_color: "blue",
    responsibilities_th: [
      "ตรวจเช็คคุณภาพงานสี ความหนาสี (DFT) ให้ได้คุณภาพตามมาตรฐานสากลและข้อกำหนดโครงการ",
    ...
    responsibilities_en: [
      "Inspect surface preparation (Sandblasting SA 2.5) and Dry Film Thickness (DFT)",
    ...
    qualifications_th: [
      "เพศ ชาย / หญิง อายุ 22 - 45 ปี",
      "วุฒิการศึกษา ปวส. - ปริญญาตรี ในสาขาที่เกี่ยวข้อง เช่น วิศวกรรมอุตสาหการ, เทคนิคการผลิต, ช่างก่อสร้าง, ช่างกลโรงงาน เป็นต้น",
      ...
      "มีความรับผิดชอบ สามารถปฏิบัติตามกฎระเบียบของบริษัทได้ดี",
      "สามารถทำงานวันจันทร์ - วันเสาร์ได้ และพร้อมที่จะเรียนรู้สิ่งใหม่ๆ ขยัน ซื่อสัตย์ และรอบคอบ"
    ],
    qualifications_en: [
      "Male / Female, aged 22 - 45 years",
      ...
      "Available to work Monday - Saturday (07:45 - 17:00)"
    ]
  },
  {
    id: 1952936,
    url: "https://www.jobthai.com/th/job/1952936",
    title_th: "เจ้าหน้าที่ตรวจสอบคุณภาพ QC (งานเชื่อม)",
    title_en: "QC Inspector (Welding & NDT)",
    category_th: "งานผลิต / ควบคุมคุณภาพ (QC Welding)",
    category_en: "Quality Assurance - Welding Inspection",
    salary_th: "ตามโครงสร้างบริษัทฯ",
    salary_en: "Company Salary Structure",
    type_th: "งานประจำ (Full-time)",
    type_en: "Full-time",
    ...
    badge_color: "emerald",
    responsibilities_th: [
      "ตรวจเช็คคุณภาพงานเชื่อม แนวเชื่อม (Visual Welding Inspection) ให้ได้คุณภาพตามมาตรฐานสากล (AWS D1.1 / ASME)",
    ...
    responsibilities_en: [
      "Perform Visual Welding Inspection (VT) per AWS D1.1, JIS, and ASME standards",
    ...
    qualifications_th: [
      ...
      "มีความรับผิดชอบ สามารถปฏิบัติตามกฎระเบียบของบริษัทได้ดี",
      "สามารถทำงานวันจันทร์ - วันเสาร์ได้ ขยัน ซื่อสัตย์ และรอบคอบ"
    ],
    qualifications_en: [
      "Male, aged 22+ years",
  ...
  {
    id: 1952930,
    url: "https://www.jobthai.com/th/job/1952930",
    title_th: "เจ้าหน้าที่ตรวจสอบคุณภาพ QC (งานประกอบ)",
    title_en: "QC Inspector (Steel Fitting & Assembly)",
    category_th: "งานผลิต / ควบคุมคุณภาพ (QC Assembly)",
    category_en: "Quality Assurance - Fabrication & Assembly",
    salary_th: "ตามโครงสร้างบริษัทฯ",
    salary_en: "Company Salary Structure",
    type_th: "งานประจำ (Full-time)",
    type_en: "Full-time",
    ...
    badge_color: "purple",
    responsibilities_th: [
      "ตรวจเช็คคุณภาพงานประกอบ Dimension, Material และ Assembly Inspection ให้ได้คุณภาพตาม Shop Drawing และมาตรฐานที่กำหนด",
    ...
    responsibilities_en: [
      "Conduct dimensional, fit-up, and assembly inspections against Tekla Shop Drawings",
    ...
    qualifications_th: [
      "เพศชาย อายุ 22 ปีขึ้นไป",
      "วุฒิการศึกษา ปวส. - ปริญญาตรี ในสาขาที่เกี่ยวข้อง เช่น เทคนิคการผลิต, ช่างก่อสร้าง, ช่างกลโรงงาน เป็นต้น",
